                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <div class="discount-coupon">
                                ...
                                <form action="#" class="coupon-form">
                                    ...
                                    <button type="submit" class="site-btn coupon-btn">Chọn</button>
                                </form>
                            </div>
                        </div>
                        <div class="col-lg-4 offset-lg-4">
                            <div class="proceed-checkout">
                                <ul>
                                    <li class="subtotal">Tạm tính <span>$248.80</span></li>
                                    <li class="cart-total">Tổng tiền <span>$248.00</span></li>
                                </ul>
                                <a href="check-out.html" class="proceed-btn">TIẾN HÀNH KIỂM TRA</a>
                            </div>
                        </div>
                    </div>
                </div>
